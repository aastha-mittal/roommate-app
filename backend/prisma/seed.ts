  ...
  const profileData = [
    {
      ...
      preferredAreas: JSON.stringify(["Squirrel Hill", "Shadyside"]),
      dormRanking: "[]",
      budgetMin: 800,
      budgetMax: 1200,
    ...
    },
    {
      ...
      onboardingComplete: true,
      housingType: "OFF_CAMPUS",
      preferredAreas: JSON.stringify(["Shadyside", "Oakland"]),
      dormRanking: "[]",
      budgetMin: 700,
      budgetMax: 1100,
      leaseDuration: "12_MONTHS",
    ...
    },
    {
      ...
      preferredAreas: JSON.stringify(["Oakland"]),
      dormRanking: "[]",
      budgetMin: 600,
      budgetMax: 900,
    ...
    },
    {
      ...
      onboardingComplete: true,
      housingType: "OFF_CAMPUS",
      preferredAreas: JSON.stringify(["Squirrel Hill", "Shadyside", "Oakland"]),
      dormRanking: "[]",
      budgetMin: 750,
      budgetMax: 1150,
      leaseDuration: "12_MONTHS",
      ...
      sharedActivities: JSON.stringify(["cooking", "hiking", "movies"]),
      bio: "ECE senior. Flexible schedule, love cooking and the outdoors.",
      tags: JSON.stringify(["ece", "cooking", "hiking", "flexible"]),
    },
    {
      userId: users[4].id,
      onboardingComplete: true,
      ...
      socialHabits: "VERY_SOCIAL",
      conflictStyle: "TALK_IT_OUT",
      sharedActivities: JSON.stringify(["parties", "concerts", "travel"]),
